...
{
    /// <inheritdoc />
    public partial class ChangeLicenceToDigitalLicence : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalLicence", x => x.LicenceId);
                    table.ForeignKey(
                        name: "FK_DigitalLicence_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalLicence_UserId",
                table: "DigitalLicence",
                column: "UserId");
        }
